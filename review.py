...
def get_review_from_openai(patch):
  ...
  question = "Code Review Request for Bugs, Issues, or Standard Violations. Say LGTM if no issues found. \n"
...
def get_review():
  ...
  for file_patch, line_number in patch_contents:
    question = "Review this diff code change for for Bugs, Issues, or Standard Violations. Say LGTM if no issues found. \n"
